...
<div class="content-wrapper">
  ...
  <div class="box-header with-border">
    <h3 class="box-title">Thêm thông tin khách hàng</h3>
  </div>
    <form id = "form" >
      ...
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" value = "Quãng Quang vũ" name = "fullname" placeholder="Enter full name">
        </div>
        <div class="form-group">
          <label >Tên viết tắt : </label>
          <input type="text" class="form-control" value = "Circle" name = "shortname"  placeholder="Enter short name">
        </div>
        <div class="form-group">
          <label >Địa chỉ : </label><span id="msg_address" style = "margin-left: 15px;color:red;" class = "msg-item"> </span><br>
          <input type="text" class="form-control" value = "Bình Chánh" name = "address" placeholder="Enter address">
        </div>
        <div class="form-group">
          <label >Số điện thoại : </label><span id="msg_phone"  style = "margin-left: 15px;color:red;" class = "msg-item"> </span><br>
          <input type="text" class="form-control" value = "01656733274" name = "phone" placeholder="Enter number phone">
        </div>
        <div class="form-group">
          <label >Email : </label><span id="msg_email" style = "margin-left: 15px;color:red;" class = "msg-item"> </span><br>
          <input type="text" class="form-control" value = "Circle.quang@tnk.com.vn" name = "email"  placeholder="Enter email">
        </div>
        <div class="form-group">
          <label >Người liên lạc : </label>
          <input type="text" class="form-control" value = "Minh Hiếu" name = "contacter"  placeholder="Enter contacter">
        </div>
        <div class="form-group">
          <label >Chú thích : </label>
          <input type="text" class="form-control" value = "Trưởng nhóm dev" name = "note" placeholder="Enter note">
        </div>
      </div>
      <!-- /.box-body -->
