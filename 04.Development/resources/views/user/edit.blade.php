...
<div class="content-wrapper">
  ...
  <div class="box-header with-border">
    <h3 class="box-title">Chỉnh sửa thông tin người dùng</h3>
    ...
    <form  id = "formdata" name = "formdata" onsubmit="return get_data()" >
      ...
      <div class="box-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id = "clear" name = "email" value = "{{$user->email}}"  placeholder="Enter email">
        </div>
        <div class="form-group">
          <label >Mật khẩu : </label><span id="msg_password" style = "margin-left: 15px;color:red;" class = "msg-item"> </span><br>
          <input type="password" class="form-control" id = "clear" name = "password" value = "123456"  placeholder="Enter password">
        </div>
        <div class="form-group">
          <label >Xác nhận mật khẩu : </label><span id="msg_repassword" style = "margin-left: 15px;color:red;" class = "msg-item"> </span><br>
          <input type="password" class="form-control" value = "123456" id = "clear" name = "repassword"  placeholder="Enter repassword">
        </div>
        <div class="form-group">
          <label >Họ : </label><span id="msg_firstname"  style = "margin-left: 15px;color:red;" class = "msg-item"> </span><br>
          <input type="text" class="form-control" id = "clear" name = "firstname" value = "{{$user->first_name}}"  placeholder="Enter first name">
        </div>
        <div class="form-group">
          <label >Tên : </label><span id="msg_lastname" style = "margin-left: 15px;color:red;" class = "msg-item"> </span><br>
          <input type="text" class="form-control" id = "clear" name = "lastname" value = "{{$user->last_name}}" placeholder="Enter last name">
        </div>
        ...
        <div class="form-group">
          ...
          @else
             <input type = "radio" name = "gender" value = "1">  <label>Nam</label>&nbsp;&nbsp;&nbsp;
               <input type = "radio" name = "gender" checked="checked" value = "0">  <label>Nữ</label> 
          @endif
        </div>
        <div class="form-group">
          <label >Địa chỉ : </label>
          <input type="text" class="form-control" id = "clear" name = "address" value = "{{$user->address}}" placeholder="Enter address">
        </div>
        <div class="form-group">
          <label >Số điện thoại : </label>
          <input type="text" class="form-control" id = "clear" name = "phone" value = "{{$user->phone}}" placeholder="Enter number phone">
        </div>
        <div class = "form-group">
          ...
          <div class="input-group input-group-sm" style = "width: 500px;">
            <select class="form-control select2 select2-hidden-accessible" data-placeholder="Enter partner" style="width: 100%;" tabindex="-1" aria-hidden="true" name = "company">
              ...
              <option value="{{$part->partner_id}}"  {{$user->partner_id ? 'selected="selected"' : '' }}>{{$part->partner_full_name}}</option>
              @endforeach
            </select> 
          </div>
        </div>
        <div class="form-group">
          ...
          @elseif($user->role == 2)
             <input type = "radio" name = "role" value = "1">  <label>TNK ADMIN</label> &nbsp;&nbsp;&nbsp;
             <input type = "radio" name = "role" checked="checked" value = "2">  <label>TNK IT USER</label> &nbsp;&nbsp;&nbsp;
             <input type = "radio" name = "role" value = "10">  <label>Partner MOD</label> &nbsp;&nbsp;&nbsp;
             <input type = "radio" name = "role" value = "11">  <label>Partner USER</label>
          @elseif($user->role == 10)
             <input type = "radio" name = "role" value = "1">  <label>TNK ADMIN</label> &nbsp;&nbsp;&nbsp;
             <input type = "radio" name = "role" value = "2">  <label>TNK IT USER</label> &nbsp;&nbsp;&nbsp;
             <input type = "radio" name = "role" checked="checked" value = "10">  <label>Partner MOD</label> &nbsp;&nbsp;&nbsp;
             <input type = "radio" name = "role" value = "11">  <label>Partner USER</label>
          @else
             <input type = "radio" name = "role" value = "1">  <label>TNK ADMIN</label> &nbsp;&nbsp;&nbsp;
             <input type = "radio" name = "role" value = "2">  <label>TNK IT USER</label> &nbsp;&nbsp;&nbsp;
             <input type = "radio" name = "role" value = "10">  <label>Partner MOD</label> &nbsp;&nbsp;&nbsp;
             <input type = "radio" name = "role" checked="checked" value = "11">  <label>Partner USER</label>
          @endif
        </div>
        <div class="form-group">
          <label>Hình ảnh :</label>
            <input type='file' name = "image" id="imgInp" />
            <img id="blah" src="{{url('img/'.$user->avatar_path)}}" width="200" />
        </div>
  ...
  function get_data() {
    ...
    $.ajax('{{url("/user_update/". $user->user_id)}}', {
